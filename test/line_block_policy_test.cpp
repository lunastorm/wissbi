...
#include "block_policy/line.hpp"
#include "msg_buf.hpp"

#include <sstream>

class LineBlockPolicyTest : public ::testing::Test, public wissbi::block_policy::Line {
    protected:
    virtual void SetUp() {
    }
...
TEST_F(LineBlockPolicyTest, Empty) {
    ...
    EXPECT_FALSE(wissbi::block_policy::Line::Read(iss, &msg_buf));
...
TEST_F(LineBlockPolicyTest, OneMsg) {
    ...
    EXPECT_TRUE(wissbi::block_policy::Line::Read(iss, &msg_buf));
